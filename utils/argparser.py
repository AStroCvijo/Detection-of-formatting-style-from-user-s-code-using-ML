...
def arg_parse():
    ...
    # Model arguments
    parser.add_argument('-m',   '--model',             type=str,   default = 'LSTM',         help="Model to use (e.g., LSTM, Transformer, N-gram)")
    ...
    # Data arguments
    parser.add_argument('-sl',  '--sequence_length',   type=int,   default = 6,              help="Length of input sequences")
